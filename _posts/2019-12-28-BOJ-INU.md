...
excerpt: "INU 송년 코드 페스티벌 풀이 및 코드 https://www.acmicpc.net/category/detail/2138"
categories: [PS]
...
1. **백트래킹**으로 P명의 조합을 구하여 모든 경우의 수를 다 따져본다. 
...
## 풀이
1. A와 B가 한 턴씩 움직이게 큐에 넣어준다.
> 또는 A, B 순서 상관없이 cnt의 오름차순으로 우선순위 큐에 넣어준다.
