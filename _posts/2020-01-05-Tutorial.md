...
![]({{ site.url }}/assets/images/diango-tutorial/0 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/1 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/3 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/5 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/6 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/7 ){: .align-center}
...
![]({{ site.url }}/assets/images/diango-tutorial/8 ){: .align-center}

localhost:8000에 접속하여 다음과 같은 화면이 뜨면 성공적으로 서버가 실행된 것이다.

![]({{ site.url }}/assets/images/diango-tutorial/9 ){: .align-center}
